...
import Award from "../assets/award1.jpeg";
import AwardSec from "../assets/award2.jpeg";
import AwardThird from "../assets/award3.jpeg";
import { Link } from "react-router-dom";
import Violin from "../assets/award1.jpeg";
import Interhouse from "../assets/award2.jpeg";
import Church from "../assets/award3.jpeg";
import "./Vision.css";
          ...
          <Item>
            <div className="moreEvents">
              <ul className="event-list col-md-12 flexy">
                ...
                <li>
                  <img src={AwardSec} alt="" className="img-fluid" />
                  <button className="event-btn">EVENT</button>
                </li>
                <li className="v-hide ">
                  <img src={AwardThird} alt="" className="img-fluid" />
                  <button className="event-btn">EVENT</button>
                </li>
              </ul>
            </div>
