      ...
      <div className="col-md-10 offset-md-1">
        <div className="comments">
          ...
          <ul>
            ...
            <li>
              Egbo Osinachi Emmanuel – <strong>Honourable Mention </strong>(in
              both Primary and Secondary school categories)
            </li>
            <li>
              Nnorom Chidubem Vincent – <strong>Honourable Mention</strong>{" "}
              (Primary school category only)
            </li>
            <li>
              Azie Kosisochukwu Able – <strong>Honourable Mention</strong>{" "}
              (primary school category only)
            </li>
            <li>
              Our super Literacy teacher, Mr. Samuel Ojiakor, did not miss out
              of the action as a he bagged a{" "}
              <strong>Teacher Champion Award</strong>.
            </li>
          </ul>
          <br />
          <p>
            Would you rather not identify with and be a part of a school widely
            known for exploits than remain where the unleashing of your child’s
